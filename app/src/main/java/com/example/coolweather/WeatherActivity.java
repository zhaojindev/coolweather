...
public class WeatherActivity extends AppCompatActivity {
    ...
    */
    public void requestWeather(String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId+"&key=9ba63b9a4ccc48d4939a2d0c0e50b947";
